...
STADIUM_DATA_VERIFIED = {
    4: ("Guaranteed Rate Field", 41.8299, -87.6338, 125, 0),
    7: ("Kauffman Stadium", 39.0510, -94.4800, 45, 0),
    14: ("Rogers Centre", 43.6414, -79.3892, 110, 1),
    15: ("Chase Field", 33.4455, -112.0667, 45, 1),
    22: ("Dodger Stadium", 34.0739, -118.2400, 30, 0),
    680: ("T-Mobile Park", 47.5914, -122.3325, 90, 1),
    2392: ("Minute Maid Park", 29.7572, -95.3551, 25, 1), 
    2602: ("Great American Ball Park", 39.0975, -84.5072, 125, 0),
    2680: ("Petco Park", 32.7076, -117.1570, 0, 0),
    2889: ("Busch Stadium", 38.6226, -90.1928, 65, 0),
    3309: ("Nationals Park", 38.8730, -77.0074, 30, 0),
    3313: ("Yankee Stadium", 40.8296, -73.9262, 75, 0),
    4169: ("loanDepot park", 25.7781, -80.2197, 40, 1),
    5325: ("Globe Life Field", 32.7473, -97.0847, 105, 1),
    2523: ("George M. Steinbrenner Field", 27.9803, -82.5067, 60, 0),
...
STADIUM_DATA = {
    ...
    9: ("American Family Field", 43.0280, -87.9712, 45, 1),
    10: ("Target Field", 44.9817, -93.2775, 90, 0),
    3289: ("Citi Field", 40.7571, -73.8458, 15, 0),
    13: ("Oakland Coliseum", 37.7516, -122.2005, 55, 0),
    16: ("Citizens Bank Park", 39.9061, -75.1665, 10, 0),
...
def insert_regular_season_stadiums(db_path):
    ...
    for stadium_id, stadium_info in STADIUM_DATA_VERIFIED.items():
        name, lat, lon, orientation, is_dome = stadium_info
        c.execute("""
            INSERT OR REPLACE INTO Stadiums (id, name, lat, lon, orientation, is_dome) 
            VALUES (?, ?, ?, ?, ?, ?)
        """, (stadium_id, name, lat, lon, orientation, is_dome))
